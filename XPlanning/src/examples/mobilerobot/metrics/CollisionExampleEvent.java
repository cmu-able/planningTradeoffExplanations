...
/**
 * {@link CollisionExampleEvent} represents a collision, where the robot bumps into obstacles at a speed greater than some
 * threshold.
 * 
 * @author rsukkerd
 *
 */
public class CollisionExampleEvent extends CollisionEvent implements IEvent<MoveToAction, CollisionDomain> {

	public CollisionExampleEvent(CollisionDomain domain, double speedThreshold) {
		super(domain, speedThreshold);
		mDomain = domain;
	...
	public double getEventProbability(Transition<MoveToAction, CollisionDomain> transition)
		...
		if (occlusion == Occlusion.CLEAR) {
			...
			return 1; //unsafeSpeed * BUMP_PROB_PARTIALLY_OCCLUDED;
		} else if (occlusion == Occlusion.OCCLUDED) {
			return 2; //unsafeSpeed * BUMP_PROB_OCCLUDED;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CollisionExampleEvent)) {
			return false;
		}
		CollisionExampleEvent event = (CollisionExampleEvent) obj;
