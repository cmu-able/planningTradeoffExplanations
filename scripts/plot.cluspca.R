plot.cluspca<-function(x, dims = c(1,2), cludesc = FALSE, what = c(TRUE,TRUE), attlabs, max.overlaps = 10, dimensions = NULL, cluster_names = NULL){
  d1 = NULL
  d2 = NULL
  gr = NULL
  olab = NULL
  ...
  if(what[1]==FALSE && what[2]==TRUE ){
    ...
    a=ggplot(data=att_df,aes(x=d1,y=d2))
